...
import Controller.ControllerTelaBuscaFornecedor;
 ...
 * @author house
 */
public class TelaBucaFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form TemplateBuscas2023
     */
    public TelaBucaFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "CNPJ", "Nome", "Inscrição Estadual", "Razão Social"
            }
        ) {
        ...
        buscaChave.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id", "nome", "fone1", "email", "status", "cnpj", "inscricaoEstadual" }));
...
dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBucaFornecedor dialog = new TelaBucaFornecedor(new javax.swing.JFrame(), true);
