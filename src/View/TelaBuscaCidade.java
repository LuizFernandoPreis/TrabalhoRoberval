...
import Controller.ControllerTelaBuscaCidade;
...
public class TelaBuscaCidade extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setForeground(new java.awt.Color(0, 51, 51));
        ...
        buscaChave.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id", "descricao", "uf" }));
        ...
        jPanFiltroLayout.setHorizontalGroup(
            ...
            .addGroup(jPanFiltroLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(buscaChave, 0, 107, Short.MAX_VALUE)
                .addGap(18, 18, 18)
